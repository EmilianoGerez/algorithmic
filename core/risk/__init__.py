...
from ..data.models import Signal, Position, SignalDirection, StrategyConfig
    ...
    def calculate_position_size(
        ...
        if stop_loss is None:
            ...
            if signal.direction == SignalDirection.LONG:
                stop_loss = signal.entry_price - (atr_decimal * Decimal(str(self.volatility_multiplier)))
            else:
                stop_loss = signal.entry_price + (atr_decimal * Decimal(str(self.volatility_multiplier)))
...
class RiskManager:
    ...
    def evaluate_signal(self, signal: Signal) -> Dict[str, any]:
        ...
        if self.metrics.daily_pnl <= -self.risk_limits.max_daily_loss * self.daily_start_balance:
    ...
    def close_position(self, position: Position, exit_price: Decimal, exit_time: datetime) -> None:
    ...
    def update_positions(self, current_prices: Dict[str, Decimal]) -> None:
        ...
        self.metrics.drawdown = (self.peak_balance - self.metrics.total_value) / self.peak_balance
    ...
    def get_portfolio_summary(self) -> Dict:
        ...
        return {
            ...
            'return_pct': float((self.metrics.total_value - self.initial_capital) / self.initial_capital * 100)
        }
    ...
    def should_stop_trading(self) -> bool:
        ...
        return (
            self.metrics.daily_pnl <= -self.risk_limits.max_daily_loss * self.daily_start_balance or
