...
from ..data.models import (
    MarketData, Signal, StrategyConfig, Position, 
    SignalDirection, TimeFrame, Candle
)
...
class StrategyRegistry:
    ...
    def create_strategy(self, strategy_name: str, config: StrategyConfig) -> BaseStrategy:
        """
