...
from core.strategy.timeframe import get_bucket_id, get_bucket_start, format_timeframe_name
...
class TimeAggregator:
    ...
    _current_bucket_id: Optional[int] = field(default=None, init=False)
    ...
    def _create_aggregated_candle(self, bucket_id: int) -> Candle:
        ...
        timestamp = datetime.fromtimestamp(bucket_start_minutes * 60, tz=timezone.utc)
