...
class Phase3Demo:
    ...
    async def demo_signal_processing(self) -> None:
        ...
        for signal in test_signals:
            print(f"Processing signal: {signal.signal_type} for {signal.symbol}")
    ...
    async def demo_risk_integration(self) -> None:
        ...
        print(f"Live trading - Total P&L: ${portfolio['total_pnl']:.2f}")
    ...
    async def demo_order_management(self) -> None:
        ...
        for order in self.demo_orders:
            ...
            print("Risk analysis - Position size: 100 shares")
        ...
        for position in positions:
            print(f"Streaming - Received market data for {position.symbol}")
    ...
    async def demo_real_time_updates(self) -> None:
        ...
        for i in range(5):
            ...
            print(
                f"  Heartbeat {i + 1}: Live={trading_status['is_running']}, "
    ...
    def _on_position_event(self, position: Position) -> None:
        ...
        print(f"Strategy validation - Position updated: {position.symbol}")
    ...
    def _on_streaming_data(self, candle: Any) -> None:
        ...
        if len(self.demo_signals) < 3:
            print(f"Performance metrics - New candle received: {candle}")
