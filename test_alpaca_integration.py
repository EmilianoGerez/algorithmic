...
def test_imports():
    ...
    try:
        from core.data.adapters import DataAdapterFactory, AlpacaAdapter
        from core.data.models import TimeFrame, MarketData
...
def test_sample_data_generation():
    ...
    try:
        from core.data.models import MarketData, Candle, TimeFrame
