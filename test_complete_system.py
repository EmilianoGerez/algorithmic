...
try:
    from core import (
        ...
        # Phase 2 - Integration
        DataAdapter, YahooFinanceAdapter, BacktraderAdapter,
        UniversalDataFeed, MultiSymbolDataFeed,
        RiskManager, RiskLimits, FixedRiskPositionSizer,
        BacktestingEngine, BacktestResult, BacktestConfig,
    ...
    try:
        from core.data.models import TimeFrame, SignalDirection, SignalType
    except:
        pass
...
class SystemIntegrationTest:
    ...
    async def test_realtime_integration(self):
        ...
        try:
            ...
            components = [
                LiveTradingEngine, StreamingManager, PaperBrokerAdapter,
                RiskManager, FVGStrategy, MultiSymbolDataFeed
            ]
        ...
        try:
            ...
            try:
                signal = Signal(
                    ...
                    signal_type=SignalType.ENTRY,
                    entry_price=Decimal('150.00'),
                    stop_loss=Decimal('155.00'),  # Invalid: stop loss above entry for long
                    take_profit=Decimal('160.00'),
                    confidence=0.9,
                    strength=0.8,
                    strategy_name="test_strategy"
    ...
    def record_test_result(self, phase: str, test_name: str, passed: bool, error: str = None):
