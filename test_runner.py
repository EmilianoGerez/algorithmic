...
def main():
    ...
    if command == "install":
        success &= run_command("pip install -r requirements.txt", "Installing main dependencies")
        success &= run_command("pip install -r dev-requirements.txt", "Installing dev dependencies")
        ...
        success &= run_command("pylint core/ tests/ --fail-under=8.0", "Linting with Pylint")
    
    elif command == "type":
        success &= run_command("mypy core/ --ignore-missing-imports", "Type checking with Mypy")
        ...
        success &= run_command("pytest tests/integration/ -v", "Running integration tests")
    
    elif command == "coverage":
        success &= run_command(
            "pytest tests/ --cov=core --cov-report=html --cov-report=term --cov-report=xml",
