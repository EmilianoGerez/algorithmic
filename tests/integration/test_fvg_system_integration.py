...
from core.data.models import Candle, TimeFrame, FVGZone, SignalDirection
...
class TestFVGSystemIntegration:
    ...
    def test_multi_timeframe_fvg_detection(self):
        ...
        for timeframe, config in configs.items():
            ...
            candles = []
            time_delta = timedelta(minutes=5 if timeframe == TimeFrame.MINUTE_5 
                                 else 15 if timeframe == TimeFrame.MINUTE_15 
                                 else 60)
    ...
    def test_fvg_performance_under_load(self, fvg_system_config):
        ...
        assert detection_time < 5.0, f"Detection took {detection_time:.2f}s, should be under 5s"
