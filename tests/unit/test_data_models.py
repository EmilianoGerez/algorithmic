...
class TestSignal:
    ...
    def test_signal_validation(self):
        ...
        assert long_signal.stop_loss is not None and long_signal.stop_loss < long_signal.entry_price
        ...
        assert short_signal.stop_loss is not None and short_signal.stop_loss > short_signal.entry_price
