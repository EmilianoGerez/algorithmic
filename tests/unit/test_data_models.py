...
from core.data.models import Candle, Signal, MarketData, TimeFrame, SignalDirection, SignalType
...
class TestCandle:
    ...
    @pytest.mark.parametrize("open_price,close_price,expected_bullish", [
        (50000, 50100, True),
        (50000, 49900, False),
